...
# reformat globalActivePower, SubMetering 1, 2, 3
subSetData_num <- tbl_df(sapply(select(subSetData, c(Global_active_power, Sub_metering_1:Sub_metering_3)),
                         as.numeric))

# plot line graphs and export to png
